    ...
    _createClass(TableRow, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            other = _objectWithoutProperties(_props, ['children', 'className', 'selectable', 'idx', 'selected', 'theme', 'rowRef']); // eslint-disable-line


        var _className = (0, _classnames3.default)(theme.row, _defineProperty({}, theme.selected, selectable && selected), className);
        return _react2.default.createElement(
          'tr',
          _extends({}, other, { className: _className, ref: function ref(element) {
              return rowRef && rowRef(element);
            } }),
