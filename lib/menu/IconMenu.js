    ...
    _createClass(IconMenu, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            theme = _props.theme,
            other = _objectWithoutProperties(_props, ['active', 'children', 'className', 'focusable', 'icon', 'iconRipple', 'inverse', 'menuRipple', 'onHide', 'onSelect', 'onShow', 'position', 'selectable', 'selected', 'theme']);
