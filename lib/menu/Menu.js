  ...
  var Menu = function (_Component) {
    ...
    function Menu() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Menu.__proto__ || Object.getPrototypeOf(Menu)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        do {
          nextIndex = (0, _utils.mod)(focusedItemIndex + 1, children.length);
        ...
        do {
          previousIndex = (0, _utils.mod)(focusedItemIndex - 1, children.length);
        ...
        var indexOfHoveredItem = children.indexOf(item);

        if (indexOfHoveredItem === _this.state.focusedItemIndex) {
          return;
        }
        _this.setState({
        ...
        var currentItem = children[focusedItemIndex || 0];
        ...
        switch (charCode) {
          ...
          case _keymap2.default.SPACE:
            _this.handleSelect(currentItem, event);
            event.preventDefault();
            event.stopPropagation();
            break;
          default:
        ...
        return _react2.default.Children.map(this.props.children, function (item) {
          ...
          if (item.type === MenuItem) {
            return _react2.default.cloneElement(item, {
              ...
              onMouseMove: _this4.handleMouseMove.bind(_this4, item)
            });
          }
          return _react2.default.cloneElement(item);
        });
