  ...
  var Menu = function (_Component) {
    ...
    function Menu() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Menu.__proto__ || Object.getPrototypeOf(Menu)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        var children = Array.from(_this.menuNode.children);
        var nextIndex = focusedItemIndex;
        do {
          nextIndex = (0, _utils.mod)(nextIndex + 1, children.length);
        } while (children[nextIndex] && (children[nextIndex].disabled || children[nextIndex].childElementCount === 0) && nextIndex !== focusedItemIndex);

        return nextIndex;
      }, _this.getPreviousSelectableItemIndex = function (focusedItemIndex) {
        var children = Array.from(_this.menuNode.children);

        var previousIndex = focusedItemIndex;
        do {
          previousIndex = (0, _utils.mod)(previousIndex - 1, children.length);
        } while (children[previousIndex] && (children[previousIndex].disabled || children[previousIndex].childElementCount === 0) && previousIndex !== focusedItemIndex);

        return previousIndex;
      }, _this.setFocusOnMouseMove = debounce(function (event) {
        var focusable = _this.props.focusable;

        if (!focusable) {
          return;
        }
        var indexOfHoveredItem = Array.from(_this.menuNode.children).findIndex(function (element) {
          return _this.isDescendant(element, event.target);
        });
        if (indexOfHoveredItem === -1 || indexOfHoveredItem === _this.state.focusedItemIndex) {
          return;
        }
        _this.setState({
        ...
        _this.menuNode.children[indexOfHoveredItem].focus();
      }, 10), _this.isDescendant = function (parent, child) {
        if (parent === child) {
          return true;
        }
        ...
        event.persist();
        _this.setFocusOnMouseMove(event);
      }, _this.handleItemKeyDown = function (item, event) {
        var focusable = _this.props.focusable;

        var childrenElements = Array.from(_this.menuNode.children);
        ...
        if (charCode === _keymap2.default.ENTER || charCode === _keymap2.default.SPACE) {
        ...
        if (newFocusedItemIndex || newFocusedItemIndex === 0) {
          event.preventDefault();
          event.stopPropagation();
          _this.menuNode.children[newFocusedItemIndex].focus();
          _this.setState({ focusedItemIndex: newFocusedItemIndex });
        }
    ...
    _createClass(Menu, [{
      ...
      value: function show() {
        ...
        var focusable = this.props.focusable;

        var children = Array.from(this.menuNode.children);
        ...
        return _react2.default.Children.map(this.props.children, function (item) {
          ...
          if (item.type === MenuItem) {
            return _react2.default.cloneElement(item, {
              ...
              onMouseMove: _this4.handleMouseMove,
              onKeyDown: _this4.handleItemKeyDown.bind(_this4, item)
            });
          }
          return _react2.default.createElement(
            'div',
            { onMouseMove: _this4.handleMouseMove, tabIndex: -1, className: theme.itemWrapper },
