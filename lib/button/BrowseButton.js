...
var factory = function factory(ripple, FontIcon) {
  var SimpleBrowseButton = function (_Component) {
    ...
    function SimpleBrowseButton() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SimpleBrowseButton.__proto__ || Object.getPrototypeOf(SimpleBrowseButton)).call.apply(_ref, [this].concat(args))), _this), _this.getLevel = function () {
        ...
        if (_this.props.triggerOnChangeForSameFile && _this.fileInput) {
    ...
    _createClass(SimpleBrowseButton, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            theme = _props.theme,
            triggerOnChangeForSameFile = _props.triggerOnChangeForSameFile,
            others = _objectWithoutProperties(_props, ['accent', 'accept', 'children', 'className', 'flat', 'floating', 'icon', 'inverse', 'label', 'mini', 'multiple', 'neutral', 'primary', 'raised', 'theme', 'triggerOnChangeForSameFile']);

        var element = 'label';
        var level = this.getLevel();
        var shape = this.getShape();

        var classes = (0, _classnames3.default)(theme.button, theme.browseButton, [theme[shape]], (_classnames = {}, _defineProperty(_classnames, theme[level], neutral), _defineProperty(_classnames, theme.mini, mini), _defineProperty(_classnames, theme.inverse, inverse), _classnames), className);
  ...
  SimpleBrowseButton.propTypes = {
    ...
    theme: _propTypes2.default.shape({
      ...
      browseButton: _propTypes2.default.string,
    ...
    triggerOnChangeForSameFile: _propTypes2.default.bool,
...
var BrowseButton = factory((0, _ripple2.default)({ centered: false }), _font_icon2.default);
exports.default = (0, _reactCssThemr.themr)(_identifiers.BUTTON, _theme3.default)(BrowseButton);
