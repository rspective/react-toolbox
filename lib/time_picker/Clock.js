...
var _utils = require('react-toolbox/lib/utils/utils');

var _time = require('react-toolbox/lib/utils/time');

var _time2 = _interopRequireDefault(_time);

var _ClockHours = require('react-toolbox/lib/time_picker/ClockHours');

var _ClockHours2 = _interopRequireDefault(_ClockHours);

var _ClockMinutes = require('react-toolbox/lib/time_picker/ClockMinutes');
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* eslint-disable import/no-extraneous-dependencies,react/jsx-filename-extension */
  ...
  function Clock() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Clock.__proto__ || Object.getPrototypeOf(Clock)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _this$state = _this.state,
          previousRadius = _this$state.radius,
          center = _this$state.center;
      var previousX = center.x,
          previousY = center.y;


      var x = left + (width / 2 - window.pageXOffset);
      var y = top + (width / 2 - window.pageXOffset);
      var radius = width / 2;
      ...
      if (previousRadius !== radius || previousX !== x || previousY !== y) {
        setTimeout(_this.handleCalculateShape, 100);
      }
