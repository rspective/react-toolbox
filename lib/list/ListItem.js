    ...
    _createClass(ListItem, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            other = _objectWithoutProperties(_props, ['className', 'ripple', 'onClick', 'onMouseDown', 'onTouchStart', 'theme', 'to', 'itemRef']);
        ...
        return _react2.default.createElement(
          'li',
          { className: theme.listItem + ' ' + className, onClick: this.handleClick, onMouseDown: onMouseDown, onTouchStart: onTouchStart, ref: function ref(element) {
              return itemRef && itemRef(element);
            } },
